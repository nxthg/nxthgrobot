...
public abstract class NXTHGNavigationModel {
	...
	public enum NavEvent {LOAD_MAP, GOTO, TRAVEL, ROTATE, STOP, GET_POSE, 
		...
		TRAVEL_SPEED, ROTATE_SPEED, RANDOM_MOVE_PARAMS, ADD_PATH, /*AUFLADEN_KISTE_KLEIN_UNTEN, AUFLADEN_KISTE_MITTEL_UNTEN, AUFLADEN_KISTE_MITELL_MITTE,
		AUFLADEN_KISTE_GROSS_OBEN,*/ AUFLADEN_PAKET, ABLADEN_PAKET,EINZIEHEN, STOP_EINZIEHEN, DREHEN, SEITWAERTS, KILLER}
