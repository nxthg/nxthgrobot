...
public class Aufladen {
	  ...
	  static int greifenklein = 2*360;					//Wie viel um ein kleines Paket zu greifen????
	  static int greifenMittel = 5*360;						//Wie viel um ein mittleres Paket zu greifen????
	  static int greifenGross = 8*360;						//Wie viel um ein großes Paket zu greifen????
	  static int greifen;
