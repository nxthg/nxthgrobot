...
//	static int ziehdrehungen = 3000; // wie viele umdrehung um ein packet auf
	...
	static int greifenMittel = 50; // Wie viel um ein mittleres Paket zu
									// greifen auseinander ????
	static int greifenGross = 11500; // Wie viel um ein großes Paket zu greifen auseinander????
	static int vergroesserung=3500;									// Vergrößerung befor der lift zum einsaugen runter fährt
	static int greifen;
