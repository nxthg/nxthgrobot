...
public abstract class NXTHGNavigationModel {
	...
	public enum NavEvent {LOAD_MAP, GOTO, TRAVEL, ROTATE, STOP, GET_POSE, 
		...
		/*CALCULATE_PATH, SOUND, GET_BATTERY, BATTERY, */ 
		PILOT_PARAMS, RANGE_FEATURE_DETECTOR_PARAMS, RANGE_SCANNER_PARAMS,
		TRAVEL_SPEED, ROTATE_SPEED, RANDOM_MOVE_PARAMS, ADD_PATH, AUFLADEN_PAKET, ABLADEN_PAKET, EINZIEHEN, STOP_EINZIEHEN, DREHEN, SEITWAERTS, FAHREN, STOP_FAHREN}
