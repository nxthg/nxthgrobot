...
public class IssPathes {
 ...
 //ERSTER DURCHLAUF:
	...
	static final Waypoint[] PATH3 = {new Waypoint(150.4, 202.7), new Waypoint(150.4, 294.7)};
	
	// ANLEITUNG: ÜBER DIE RAMPE FAHREN!
	...
	static final Waypoint[] PATH4 = {new Waypoint(150.4, 332.0), new Waypoint(191.3, 489.0), new Waypoint(273.2, 508.2)};
