...
public class NXTHGSliderPanel_Drehen extends JPanel implements ActionListener, ChangeListener {
	...
	public NXTHGSliderPanel_Drehen(NXTHGPCNavigationModel model, NavEvent event, String sliderLabel, String buttonLabel, int maxValue) {
		slider  = new JSlider(-15,15);
		this.model = model;
		this.event = event;
		...
		slider.setMajorTickSpacing(maxValue/5);
