...
public class NXTHGSliderPanel extends JPanel implements ActionListener, ChangeListener {
	...
	public NXTHGSliderPanel(NXTHGPCNavigationModel model, NavEvent event, String sliderLabel, String buttonLabel, int maxValue) {
