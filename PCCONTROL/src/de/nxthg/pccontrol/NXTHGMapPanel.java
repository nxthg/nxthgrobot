...
public class NXTHGMapPanel extends JPanel {
	...
	protected NXTHGNavigationPanel parent;
	 ...
	 */
	public NXTHGMapPanel(NXTHGPCNavigationModel model, Dimension size, NXTHGNavigationPanel parent) {
		this.size = size;
		this.model = model;
