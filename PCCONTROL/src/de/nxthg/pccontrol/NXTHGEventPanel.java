 ...
 */
public class NXTHGEventPanel extends JPanel implements ActionListener {
	...
	public NXTHGEventPanel(NXTHGPCNavigationModel model, NXTHGNavigationPanel panel, NavEvent[] events) {
